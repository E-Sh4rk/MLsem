...
j=10,q=0,l=0,i=0,p=0,k=m,g=n,d=0,e=m;while(a[d]=="%")d++;for(;;d++)if(a[d]=="#")i=1;else if(a[d]==h)g=h;else if(a[d]==f)p=1;else if(a[d]==n||a[d]==o)k=a[d];else
...
t(a,b){return i(BigInt(a)-BigInt(b))}return{wasm_z_sub:t,wasm_z_size:s,wasm_z_serialize:r,wasm_z_positive:q,wasm_z_of_js_string_base:p,wasm_z_neg:l,wasm_z_hash:k,wasm_z_format:j,wasm_z_equal:g,wasm_z_deserialize:d,wasm_z_compare:c,wasm_z_add:b}}(globalThis))({"link":[["code-399cbb5f16198fcb2c7e",0]],"generated":(a=>{var
